...
```{r}
auditor_cpc <- import_cpc_files(filepath="../data/raw/City Hall Data - Jan 2021/Auditor CPC077 MOD025", regex_pattern="*.TXT", skip_key="#YY/MM/DD")

mainroom_al_cpc <- import_cpc_files(filepath="../data/raw/City Hall Data - Jan 2021/Main Room AL CPC077 MOD025", regex_pattern="*.TXT", skip_key="#YY/MM/DD")

veterans_al_cpc <- import_cpc_files(filepath="../data/raw/City Hall Data - Jan 2021/Veterans AL MOD030", regex_pattern="*.TXT", skip_key="#YY/MM/DD")

engineering_cpc <- import_cpc_files(filepath="../data/raw/City Hall Data - Jan 2021/Engineering CH CPC015 MOD030", regex_pattern="*.TXT", skip_key=13)

outdoor_al_cpc <- import_cpc_files(filepath="../data/raw/City Hall Data - Jan 2021/Outdoor AL CPC016 MOD045", regex_pattern="*.TXT", skip_key=13)

outdoor_ch_cpc <- import_cpc_files(filepath="../data/raw/City Hall Data - Jan 2021/Outdoor CH CPC016 MOD045", regex_pattern="*.TXT", skip_key=13)

waterdept_cpc <- import_cpc_files(filepath="../data/raw/City Hall Data - Jan 2021/Water Dept CH CPC077 MOD025", regex_pattern="*.TXT", skip_key=14)
...
auditor_PM <- import_pm_files(
  filepath = "../data/raw/City Hall Data - Jan 2021/Auditor CPC077 MOD025")

mainroom_PM <- import_pm_files(
  filepath = "../data/raw/City Hall Data - Jan 2021/Main Room AL CPC077 MOD025")

veterans_al_PM <- import_pm_files(
  filepath = "../data/raw/City Hall Data - Jan 2021/Veterans AL MOD030")
...
outdoor_al_PM <- import_pm_files(
  filepath = "../data/raw/City Hall Data - Jan 2021/Outdoor AL CPC016 MOD045")

outdoor_ch_PM <- import_pm_files(
  filepath = "../data/raw/City Hall Data - Jan 2021/Outdoor CH CPC016 MOD045")

waterdept_PM <- import_pm_files(
  filepath = "../data/raw/City Hall Data - Jan 2021/Water Dept CH CPC077 MOD025") 
...
```{r}
nm <- list.files(path="../data/raw/City Hall Data - Jan 2021/Outdoor CH CPC016 MOD045", pattern="*.csv", full.names = TRUE)
...
```{r}
auditor_merged$HEPA_on = ifelse(
  auditor_merged$date1min > 
    as.POSIXct("2021-01-19 09:20:00", tz='America/New_York'), 1, 0)

mainroom_merged$HEPA_on = ifelse(
  mainroom_merged$date1min > 
    as.POSIXct("2021-01-27 12:30:00", tz='America/New_York'), 1, 0)

waterdept_merged$HEPA_on = ifelse(
  waterdept_merged$date1min > 
    as.POSIXct("2021-01-11 10:05:00", tz='America/New_York'), 1, 0)

engineering_merged$HEPA_on = ifelse(
  engineering_merged$date1min > 
    as.POSIXct("2021-01-11 10:45:00", tz='America/New_York'), 1, 0)

veterans_merged$HEPA_on = ifelse(
  veterans_merged$date1min > 
    as.POSIXct("2021-01-27 09:30:00", tz='America/New_York'), 1, 0)

clerk_merged$HEPA_on = ifelse(
  clerk_merged$date1min > 
    as.POSIXct("2021-01-19 09:11:00", tz='America/New_York'), 1, 0)
```
...
```{r}
merged <- list("CH_engineering_merged" = engineering_merged, 
               "CH_waterdept_merged" = waterdept_merged, 
               "CH_mainroom_merged" = mainroom_merged, 
               "CH_auditor_merged" = auditor_merged, 
               "CH_veterans_merged" = veterans_merged, 
               "CH_clerk_merged" = clerk_merged)
```
...
mapply(
  ...
  x=merged, file=paste("../data/merged", paste(names(merged), "csv", sep="."), sep="/"), #for each dataframe, use its name to make a csv of it

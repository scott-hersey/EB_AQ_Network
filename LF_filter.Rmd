...
```{r}
admin_merged <- import_ratio_data("./data/LF_admin_merged.csv")
class1_merged <- import_ratio_data("./data/LF_class1_merged.csv")
class2_merged <- import_ratio_data("./data/LF_class2_merged.csv")
class3_merged <- import_ratio_data("./data/LF_class3_merged.csv")
class4_merged <- import_ratio_data("./data/LF_class4_merged.csv")
```

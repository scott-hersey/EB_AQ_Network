...
business_cpc <- import_cpc_files(
  filepath="../data/raw/Revere High School - Mar 2021/Business - CPC077 MOD099")
...
superintendent_cpc <- import_cpc_files(
  filepath = "../data/raw/Revere High School - Mar 2021/Superintendent - CPC015 MOD111")

class210_cpc <- import_cpc_files(
  filepath = "../data/raw/Revere High School - Mar 2021/Class 210")

classc11_cpc <- import_cpc_files(
  filepath = "../data/raw/Revere High School - Mar 2021/Class C11")

class120_cpc <- import_cpc_files(
  filepath = c(
    "../data/raw/Revere High School - Mar 2021/Class120_outdoor/MCPC 016 - indoor 15mar-22mar", 
    "../data/raw/Revere High School - Mar 2021/Class C120_outdoor/MCPC 015 - indoor 22mar-24mar"), skip_key = 13) #Had to hard-code this value, not sure why

outdoor_class_cpc <- import_cpc_files(
  filepath = "../data/raw/Revere High School - Mar 2021/Class120_outdoor/MCPC 016 - outdoor 22mar-24mar")
...
cpc_admin_list$principal <- read_csv("../data/raw/revere_high_principal_cpc.csv")
cpc_admin_list$outdoor <- read_csv("../data/raw/revere_high_outdoor_cpc.csv")
...
business_PM <- import_pm_files(filepath="../data/raw/Revere High School - Mar 2021/Business - CPC077 MOD099")

business_s1_PM <- import_pm_files(
  filepath="../data/raw", regex_pattern = "data.mod-pm-00128.final.csv")

business_s2_PM <- import_pm_files(
  filepath = "../data/raw/Modulair-PM Data", regex_pattern = "124.*.csv")

principal_PM <- import_pm_files(
  filepath="../data/raw", regex_pattern = "data.mod-pm-00126.final.csv")

principal_s1_PM <- import_pm_files(
  filepath = "../data/raw/Modulair-PM Data", regex_pattern = "112.*.csv")
...
superintendent_assist_PM <- import_pm_files(
  filepath="../data/raw/Modulair-PM Data", regex_pattern = "130.*.csv")
...
class120_PM <- import_pm_files(
  filepath = "../data/raw/Modulair-PM Data", regex_pattern = "126.*.csv")
...
```{r}
admin_rooms <- sapply(
  names(cpc_admin_list), 
  function(k) merge(cpc_admin_list2[[k]], 
                    pm_admin_list[[k]], 
                    by.x = "date1min", 
                    by.y = "date", 
                    all = TRUE), 
...
class_rooms <- sapply(
  names(cpc_classroom_list), 
  function(k) merge(cpc_classroom_list2[[k]], 
                    pm_classroom_list[[k]], 
                    by.x = "date1min", 
                    by.y = "date", 
                    all = TRUE), 

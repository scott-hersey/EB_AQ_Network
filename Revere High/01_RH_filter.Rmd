...
business_filt <- set_NA(business_filt, "2021-03-11 12:00:00", "2021-03-12 8:00:00")
...
business_s1_filt <- set_NA(business_s1, "2021-03-11 12:00:00", "2021-03-12 8:00:00")
...
business_s2_filt <- set_NA(business_s2, "2021-03-11 12:00:00", "2021-03-12 8:00:00")
plot_time_resolved(business_s2_filt, FALSE)
```
...
principal_filt <- set_NA(principal_filt, "2021-03-11 12:00:00", "2021-03-12 8:00:00")
...
principal_s1_filt <- set_NA(principal_s1_filt, "2021-03-11 12:00:00", "2021-03-12 8:00:00")
...
principal_s2_filt <- set_NA(principal_s2, "2021-03-11 12:00:00", "2021-03-12 8:00:00")
plot_time_resolved(principal_s2_filt, FALSE)
```
...
superintendent_filt <- set_NA(superintendent_filt, "2021-03-11 12:00:00", "2021-03-12 8:00:00")
...
superintendent_assist_filt <- set_NA(superintendent_assist_filt, "2021-03-11 12:00:00", "2021-03-12 8:00:00")
...
filtered <- list(
  ...
  "RH_business_s1_filt" = business_s1_filt,
  "RH_business_s2_filt" = business_s2_filt, 
  "RH_principal_filt" = principal_filt, 
  "RH_principal_s1_filt" = principal_s1_filt, 
  "RH_principal_s2_filt" = principal_s2_filt, 

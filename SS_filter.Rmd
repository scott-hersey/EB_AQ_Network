...
```{r}
front_merged <- import_ratio_data("./data/SS_front_merged.csv")
infant_merged <- import_ratio_data("./data/SS_infant_merged.csv")
kitchen_merged <- import_ratio_data("./data/SS_kitchen_merged.csv")
preschool_merged <- import_ratio_data("./data/SS_preschool_merged.csv")
toddler_merged <- import_ratio_data("./data/SS_toddler_merged.csv")
```

...
In this notebook, I clean the sensor data from Shining Star.
...
```{r}
outdoor_cpc <- import_cpc_files(filepath="../data/raw/Shining Star/Outdoor") 

infant_cpc <- import_cpc_files(
  filepath="../data/raw/Shining Star/Infant Room") 
preschool_cpc <- import_cpc_files(filepath="../data/raw/Shining Star/Preschool Room") 
...
outdoor_PM <- import_pm_files(
  filepath="../data/raw/Shining Star/Modulair-PM Data", regex_pattern="114.*.csv")

preschool_PM <- import_pm_files(
  filepath="../data/raw", regex_pattern = "data.mod-pm-00126.final.csv")

infant_PM <- import_pm_files(
  filepath="../data/raw/Shining Star/Modulair-PM Data", regex_pattern="099.*.csv")

toddler_PM <- import_pm_files(
  filepath="../data/raw/Shining Star/Modulair-PM Data", regex_pattern="125.*.csv")

front_PM <- import_pm_files(
  filepath="../data/raw/Shining Star/Modulair-PM Data", regex_pattern="104.*.csv")

kitchen_PM <- import_pm_files(
  filepath="../data/raw/Shining Star/Modulair-PM Data", regex_pattern="111.*.csv")

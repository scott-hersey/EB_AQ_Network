...
write.csv(sn45, "sn45.csv", row.names = FALSE)
```
...
write.csv(sn49, "sn49.csv", row.names = FALSE)
```
...
write.csv(sn62, "sn62.csv", row.names = FALSE)
```
...
write.csv(sn67, "sn67.csv", row.names = FALSE)
```
...
Below I include the code I wrote to check the data cleaning results

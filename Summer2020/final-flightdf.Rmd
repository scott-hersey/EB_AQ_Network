...
```{r}
#importing 2019 data 
flightdf1 <- read.csv("data/Olin2019dataset.csv", header=TRUE, fileEncoding="UTF-8-BOM")

#importing Jan 2020 data
flightdf2 <- read_excel("data/2020-Jan-Runway use start.xlsx")

#importing Feb - Apr 2020 data
lst <- lapply(1:3, function(i) read_excel("data/OlinFebruaryApril2020dataset.xlsx", sheet = i))

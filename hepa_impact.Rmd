...
```{r}
waterdept_ratio_pchange <- (mean_concent_ratios$waterdept_HEPA$val[1] - mean_concent_ratios$waterdept$val[1])/mean_concent_ratios$waterdept$val[1] * 100

auditor_ratio_pchange <- (mean_concent_ratios$auditor_HEPA$val[1] - mean_concent_ratios$auditor$val[1])/mean_concent_ratios$auditor$val[1] * 100

mainroom_ratio_pchange <- (mean_concent_ratios$mainroom_HEPA$val[1] - mean_concent_ratios$mainroom$val[1])/mean_concent_ratios$mainroom$val[1] * 100

paste('Water Department:', waterdept_ratio_pchange, "% decrease")
paste('Auditor Room:', auditor_ratio_pchange, "% decrease")
paste('Main Room:', mainroom_ratio_pchange, "% decrease")
...
'pm1_ratio', 'bin0_ratio', 'bin0_ratio', 'neph_bin0_ratio', key="ratio_type", value="value")
...
'pm1_ratio.HEPA', 'bin0_ratio.HEPA', 'neph_bin0_ratio.HEPA', key="ratio_type", value="value")
